...
Product Group, and Quantity\n")
print("2. Sort Item# column by alphabetical order\n")
print("3. Click on Quantity Column, change the format to Number in the Number \
tab on the top bar of excel. Then move the Decimal over 2 to the right 2 spots\n")
print("4. Save file as .csv and place it in the folder this program is in\n")
print("5. Type 'Quit' to end the program\n")

open_file=0

while open_file != "Quit":
